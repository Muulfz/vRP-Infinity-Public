...
local lang = {
    ...
    commands = {
        admin = {
            kick = {
                ...
                reason_default = "Kicked"
            },
            coords = {
                cmd = "coords",
                description = "Copy the coordinates using Ctrl-A Ctrl-C"
            },
            revive = {
                cmd = "revive",
                description = "relive a player"
            },
            noclip = {
                cmd = "noclip",
                description = "Makes a player invisible and Unreachable"
            },
            add_group = {
                cmd = "add_group",
            },
            remove_group = {
                cmd = "removegroup",
                description = "Remove a player from group"
            },
            set_money = {
                cmd = "setmoney",
            },
        ...
        missing_arguments = "~r~Missing arguments",
        missions = {
            cancel = {
                cmd = "stopmission",
            }
        ...
        police = {
            ...
            show_police_records = {
                cmd = "show_police_records"
            },

            delete_police_records = {
                cmd = "delete_police_records"
            },
            close_business = {
                cmd = "close_business"
            },
    ...
    basic_menu = {
        admin = {
            ...
            player_list = {
                title = "@User list",
                description = "Show/hide userlist"
            },
            whitelist = {
